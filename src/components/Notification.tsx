...
const NotificationList = () => {
  ...
  z-20 flex items-end px-4 py-6 sm:p-6`}
    >
...
const Notification = ({ type, message, description, txid, onHide }) => {
  ...
  return (
    <div
      className="bg-bkg-1 pointer-events-auto z-50 mx-4
    mt-2 mb-12 w-full max-w-sm overflow-hidden rounded-md
    bg-[#0a1023] p-2 shadow-lg right-1"
    >
      <div className="p-4">
        <div className="flex items-center">
          ...
          <div className="ml-4 flex flex-shrink-0 self-start">
            <button
            onClick={() => onHide()}
            className="bg-bkg-2 default-transition text-fgd-3
