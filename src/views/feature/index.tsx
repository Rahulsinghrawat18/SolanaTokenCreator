...
export const FeatureView: FC<MyComponentProps> = ({
  setOpenAirdrop,
  setOpenContact,
  setOpenCreateModal,
  ...
  const features = [
    {
      ...
      description:
        "Start working with solana token creator, it allows you to create solana token by creating, deploying, airdrop, transferring and update token",
  ...
  return (
    <section id="features" className="py-20">
      <div className="container">
        ...
        <div
          className="bg-default-950/40 flex
        flex-wrap items-center rounded-3xl
        backdrop-blur-3xl"
        >
            ...
            >
              <div className="p-8 sm:p-10">
                ...
                <a onClick={() => list.function(true)}
                  className="hover:bg-primary inline-flex
