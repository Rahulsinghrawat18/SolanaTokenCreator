...
export const ContactView: FC<myComponentProps> = ({ setOpenContact }) => {
  const [state, handleSubmit] = useForm("mgvadgqw");
  if (state.succeeded) {
    setOpenContact(false);
    notify({
      type: "success",
      message: "Thanks for submitting you message, will get back to you.",
    });
  }
  ...
  backdrop-blur-2xl"
      ...
      flex-col p-10"
          ...
          mx-auto mb-5 max-w-sm"
                  >
                    Send your message to work together on something amazing.
                  </p>
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      mb-2 block font-semibold"
                        ...
                        <input
                          ...
                          id="email"
                          name="email"
                          className="border-default-200 block w-full
                      rounded border-white/10 bg-transparent
                      ...
                      <textarea
                        ...
                        id="message"
                        rows={6}
                        className="border-default-200 relative block w-full
                    rounded border-white/10 bg-transparent
                    py-1.5 px-3 text-white/80 focus:border-white/25
                    focus:ring-transparent"
                        placeholder="message"
                ...
                group mt-5 inline-flex w-full items-center justify-center
                rounded-lg px-6 py-2 text-white backdrop-blur-2xl
